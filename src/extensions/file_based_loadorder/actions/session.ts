...
import { IInvalidResult, LoadOrder, LoadOrderValidationError } from '../types/types';
...
export const setFBValidationError =
  createAction('SET_FB_VALIDATION_ERRORS', (profileId: string, error: LoadOrderValidationError) => ({ profileId, error })) as any;